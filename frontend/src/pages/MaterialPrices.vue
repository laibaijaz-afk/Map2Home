  ...
  <div class="min-h-screen py-8 relative overflow-hidden">
    ...
    <main class="container mx-auto px-4 py-8 relative z-20">
      ...
      <div class="mb-10 text-center">
        ...
        <p class="text-xl text-wood-700">Latest material prices from MaterialRate.pk - Updated regularly for accurate cost estimation</p>
      </div>
      ...
      <div v-else class="construction-card overflow-hidden">
        ...
        <div v-if="filteredMaterials.length > 0" class="bg-gradient-to-r from-wood-100 to-wood-50 px-6 py-4 border-t-2 border-wood-300/50">
          <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div v-if="lastScraped" class="text-xs text-gray-500 flex items-center gap-2">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <span>Last scraped: <strong>{{ formatDate(lastScraped) }}</strong></span>
            </div>
        ...
        <div class="flex items-start">
          ...
          <div>
            ...
            <ul class="text-sm text-blue-800 space-y-1 list-disc list-inside">
              <li>Prices are scraped from multiple trusted Pakistani sources including MaterialRate.pk, PricesIn.pk, BrightoPaints.com, and more</li>
