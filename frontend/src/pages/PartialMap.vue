<template>
  <div class="min-h-screen bg-gradient-to-br from-blue-50 to-cyan-50">
    ...
    <main class="max-w-7xl mx-auto px-6 py-12">
      <div class="mb-8">
        <h2 class="text-3xl font-bold text-gray-800">Location map</h2>
        <p class="text-gray-600 mt-2 text-sm">Satellite or street view around an address — separate from floor-plan “partial match” badges in Services &amp; Planning.</p>
      </div>
      <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div class="lg:col-span-1">
          <div class="bg-white rounded-lg shadow-lg p-6 sticky top-6">
            ...
            >
              {{ isGenerating ? 'Generating...' : 'Generate location map' }}
            </button>
          ...
          <div class="bg-white rounded-lg shadow-lg overflow-hidden mb-6">
            ...
            >
              ...
              <div class="text-center">
                ...
                <h3 class="text-xl font-semibold text-gray-600 mb-2">Location map (geographic)</h3>
                <p class="text-gray-500 mb-4">Enter an address and generate — this is your real-world site map, not a floor-plan match score.</p>
