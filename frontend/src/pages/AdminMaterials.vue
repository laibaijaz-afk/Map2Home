      ...
      <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div class="flex items-center gap-4">
          ...
          >
            ...
            {{ scraping ? 'Scraping...' : 'Scrape Prices' }}
          </button>
          <button
            @click="exportToCSV"
        ...
        <div class="bg-gradient-to-r from-blue-500 to-indigo-500 px-6 py-4">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-sm text-blue-100">View history of automatic price scraping from all sources</p>
            </div>
            <button
        ...
        <div class="flex items-start">
          ...
          <div>
            ...
            <ul class="text-sm text-blue-800 space-y-1 list-disc list-inside">
              ...
              <li><strong>Auto-updates:</strong> Prices are automatically scraped from multiple sources every 30 minutes</li>
