...
const register = async (req, res, next) => {
  try {
    ...
    console.log('[authController.register] payload received:', { name, email, passwordPresent: !!password, confirmPasswordPresent: !!confirmPassword });

    // Enforce required fields: name, email, password (confirmPassword is optional)
    ...
    const [result] = await connection.query(
      'INSERT INTO users (name, email, password_hash, is_verified, google_account, created_at) VALUES (?, ?, ?, ?, ?, NOW())',
