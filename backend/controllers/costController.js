...
// Updated 2026 - Based on materialrate.pk market rates
const FALLBACK_MATERIAL_PRICES = { 
  cement: { price: 1390, unit: 'bag' },           // Rs 1,390 per bag (50kg) - Average of Lucky 1385-1400, DG Khan 1410-1420
  sand: { price: 10000, unit: 'truck' },          // Rs 10,000 per trolley (200 cu ft) - Average of Ravi/Chenab
  bricks: { price: 17, unit: 'piece' },           // Rs 17 per brick - average of 15-19
  steel: { price: 238000, unit: 'ton' },          // Rs 238,000 per ton - average of brands on materialrate.pk
  gravel: { price: 25500, unit: 'truck' },        // Rs 25,500 per trolley (200 cu ft) - Average of Margalla/Sargodha bajri
  tiles: { price: 400, unit: 'sqm' },             // Rs 400 per sqm (standard tiles)
  paint: { price: 1250, unit: 'liter' },           // Rs 1,250 per liter (Brighto Plastic Emulsion avg)
  wood: { price: 1000, unit: 'sqft' },            // Rs 1,000 per sqft
  electricalWire: { price: 83, unit: 'meter' },     // Rs 83 per meter (1x1.5mm cable from brieflyshort.com)
  plumbingPipe: { price: 463, unit: 'meter' },     // Rs 463 per meter (32mm PN-16 PPRC from icons.com.pk)
  glass: { price: 193, unit: 'sqft' },            // Rs 193 per sqft (6mm clear glass from parklane-city.com)
  aluminum: { price: 1450, unit: 'sqft' },        // Rs 1,450 per sqft (avg from pricesin.pk)
